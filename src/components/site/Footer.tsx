      ...
      <div className="mx-auto max-w-[1600px]">
        <div className="flex flex-col gap-12 md:flex-row md:items-end md:justify-between">
          <div>
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="tech text-muted-foreground text-xs">SUBVERSE // SÃO PAULO // BRASIL</p>
        ...
        <div className="hairline mt-16 flex flex-col gap-6 pt-8 md:flex-row md:items-center md:justify-between">
          <div className="flex flex-wrap items-center gap-4 sm:gap-8">
            <Link to="/universe" className="tech text-muted-foreground hover:text-foreground transition-colors text-xs py-1">
              UNIVERSE
            </Link>
            <Link
              to="/drops/$slug"
            ...
            <Link to="/products" className="tech text-muted-foreground hover:text-foreground transition-colors text-xs py-1">
              PRODUTOS
            </Link>
            <Link to="/archive" className="tech text-muted-foreground hover:text-foreground transition-colors text-xs py-1">
              ARCHIVE
            </Link>
            <Link to="/manifesto" className="tech text-muted-foreground hover:text-foreground transition-colors text-xs py-1">
              MANIFESTO
            </Link>
          </div>
