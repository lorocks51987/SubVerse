...
function Universe() {
  return (
    <div className="concrete-surface pt-28">
            ...
            <Reveal>
              <div className="relative flex items-center justify-center p-8 border border-border bg-neutral-950/40">
                ...
                <div className="absolute top-4 left-4">
                  <span className="tech bg-background/90 px-2.5 py-1 text-[0.65rem] border border-border text-foreground">
                    SÍMBOLO CENTRAL
                  </span>
                </div>
                <span className="tech absolute bottom-4 right-4 text-muted-foreground">
                  SIGN // ETERNO
                </span>
              </div>
            </Reveal>
      ...
      <Marquee text="SUBVERSO — SUBVERSÃO — OUROBOROS — NÃO É SOBRE O QUE VOCÊ VESTE" items={5} />
    </div>
  );
}
